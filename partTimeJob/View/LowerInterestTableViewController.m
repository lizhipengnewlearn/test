//
//  LowerInterestTableViewController.m
//  partTimeJob
//
...
@interface LowerInterestTableViewController ()

@end

@implementation LowerInterestTableViewController
...
- (void)refreshData{
    ...
    [query orderByDescending:@"orderByLowerInterestRate"];
