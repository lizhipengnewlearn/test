...
@interface QuicklyTableViewController ()

@end

@implementation QuicklyTableViewController
...
- (void)refreshData{
    ...
    [query orderByDescending:@"orderByLoanEfficiency"];
